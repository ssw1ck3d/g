...
class Calendar {
    ...
    element = (h("div", null, "Ceci n'est pas un calendrier"));
    calCSS = css `
        min-height: 355px;
        bottom: 60px;
        right: 10px;
    ...
    async init() {
        ...
        this.element = (h(Panel, { class: [
                ...
                this.show,
                this.calCSS,
            ], width: "380px", height: "30%", grow: true, id: "calendar" },
            h("div", { class: ["calContent"], "on:contextmenu": (e) => e.preventDefault() },
                h("iframe", { style: "width: 100%; height: 100%; border: none; margin: 0; padding: 0;background: transparent;", "on:contextmenu": (e) => e.preventDefault(), srcdoc: `
                  <!DOCTYPE html>
