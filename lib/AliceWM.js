...
class WMWindow extends EventTarget {
    ...
    snapPreview(side) {
        ...
        const elem = (h("div", { class: `snapPreview-${side}`, id: "snapPreview", style: `${side}: 0px; width: ${scaledWidth}px; height: ${scaledHeight}px; opacity: 0;` }));
        setTimeout(() => {
